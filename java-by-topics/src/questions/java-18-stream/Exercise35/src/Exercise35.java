 ...
 */
/**
 * Expected Output [144, 169, 196, 225] [Stream] [Collection, Reflection, Stream] [Stream, Reflection, Collection] Squeare Set: [16, 36, 25] The Square of each elements: 25 16 25 36 The sum is: 10
 */
class Exercise35 {
        public static void main(String args[]) {
                ...
                List<Integer> squares =
                                numbers.stream().map(e -> e * e).toList();
                // Code here ...
                ...
                List<String> filteredList =
                                names.stream().filter(e -> e.startsWith("S"))
                ...
                // // Code here ...
                List<Integer> squareSet = anotherNumbers.stream().distinct()
                                .sorted().map(e -> e * e)
                                .collect(Collectors.toList());
